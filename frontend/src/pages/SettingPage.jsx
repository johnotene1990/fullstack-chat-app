...
const SettingPage = () => {
  ...
  // 👇 Add this hook to apply theme globally
  // useEffect(() => {
    ...
    <div className='h-screen container mx-auto px-4 pt-20 max-w-5xl'>
      ...
      <div className='space-y-6'>
        ...
        <p className='text-sm text-base-content/70'>
          Choose a theme for your chat interaction
        </p>
      </div>
            ...
            <div className='bg-base-100 rounded-xl shadow-sm overflow-hidden'>
              ...
              <div className='p-4 space-y-4 min-h-[200px] max-h-[200px] overflow-y-auto bg-base-100'>
                {PREVIEW_MESSAGES.map((message) => (
                  ...
                  >
                    <div
                      className={`px-3 rounded-xl shadow-sm max-w-[80%] ${message.isSent
              ...
              {/* Chat input preview */}
              <div className='px-4 border-t border-base-300 flex items-center gap-2'>
